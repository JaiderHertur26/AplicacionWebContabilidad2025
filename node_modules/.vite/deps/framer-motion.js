...
// node_modules/framer-motion/dist/es/motion/utils/use-visual-element.mjs
function useVisualElement(Component, visualState, props, createVisualElement2) {
...
// node_modules/framer-motion/dist/es/motion/index.mjs
function createMotionComponent({ preloadedFeatures: preloadedFeatures2, createVisualElement: createVisualElement2, useRender, useVisualState: useVisualState2, Component }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser) {
      context.visualElement = useVisualElement(Component, visualState, configAndProps, createVisualElement2);
...
var color = {
  test: (v) => rgba.test(v) || hex.test(v) || (void 0).test(v),
  parse: (v) => {
    if (rgba.test(v)) {
      return rgba.parse(v);
    } else if ((void 0).test(v)) {
      return (void 0).parse(v);
    } else {
      return hex.parse(v);
    }
  },
  transform: (v) => {
    return isString(v) ? v : v.hasOwnProperty("red") ? rgba.transform(v) : (void 0).transform(v);
  }
};
...
var colorTypes = [hex, rgba, void 0];
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  config = { ...(0, import_react19.useContext)(MotionConfigContext), ...config };
  config.isStatic = useConstant(() => config.isStatic);
  const context = (0, import_react19.useMemo)(() => config, [JSON.stringify(config.transition), config.transformPagePoint, config.reducedMotion]);
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react20.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react20.useRef)(void 0);
  ...
  return React3.createElement(LazyContext.Provider, { value: { renderer: loadedRenderer.current, strict } }, children);
}
...
var DeprecatedLayoutGroupContext = (0, import_react21.createContext)(null);
...
var LayoutGroup = ({ children, id: id4, inherit = true }) => {
  const layoutGroupContext = (0, import_react24.useContext)(LayoutGroupContext);
  const deprecatedLayoutGroupContext = (0, import_react24.useContext)(DeprecatedLayoutGroupContext);
  const [forceRender, key] = useForceUpdate();
  const context = (0, import_react24.useRef)(null);
  ...
  const memoizedContext = (0, import_react24.useMemo)(() => ({ ...context.current, forceRender }), [key]);
  return React4.createElement(LayoutGroupContext.Provider, { value: memoizedContext }, children);
};
...
var ReorderContext = (0, import_react25.createContext)(null);
...
function ReorderGroup({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const order = [];
  const isReordering = (0, import_react26.useRef)(false);
  ...
  return React5.createElement(
    ...
    React5.createElement(ReorderContext.Provider, { value: context }, children)
  );
}
var Group = (0, import_react26.forwardRef)(ReorderGroup);
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  return React6.createElement(Component, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point2.x, y: point2.y, zIndex }, layout: layout2, onDrag: (event, gesturePoint) => {
    const { velocity } = gesturePoint;
    velocity[axis] && updateOrder(value, point2[axis].get(), velocity[axis]);
    onDrag && onDrag(event, gesturePoint);
  }, onLayoutMeasure: (measured) => registerItem(value, measured), ref: externalRef, ignoreStrict: true }, children);
}
var Item = (0, import_react28.forwardRef)(ReorderItem);
...
function useSpring(source, config = {}) {
  ...
  const activeSpringAnimation = (0, import_react29.useRef)(null);
...
function useAnimationFrame(callback) {
  const initialTimestamp = (0, import_react32.useRef)(0);
...
function useReducedMotion() {
  ...
  const [shouldReduceMotion] = (0, import_react33.useState)(prefersReducedMotion.current);
  if (true) {
...
function useReducedMotionConfig() {
  ...
  const { reducedMotion } = (0, import_react34.useContext)(MotionConfigContext);
...
function useUnmountEffect(callback) {
  return (0, import_react35.useEffect)(() => () => callback(), []);
}
...
function createGeneratorEasing(options, scale2 = 100) {
  const generator = (void 0)({ keyframes: [0, scale2], ...options });
...
function useCycle(...items) {
  const index2 = (0, import_react36.useRef)(0);
  const [item, setItem] = (0, import_react36.useState)(items[index2.current]);
...
function useAnimatedState(initialState) {
  const [animationState, setAnimationState] = (0, import_react40.useState)(initialState);
...
function useInvertedScale(scale2) {
  ...
  const { visualElement } = (0, import_react41.useContext)(MotionContext);
...
var export_AnimatePresence = void 0;
var export_spring = void 0;
export {
  export_AnimatePresence as AnimatePresence,
  AnimateSharedLayout,
